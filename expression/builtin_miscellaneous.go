...
var (
	...
	_ functionClass = &mainPosWaitFunctionClass{}
...
type mainPosWaitFunctionClass struct {
	baseFunctionClass
}

func (c *mainPosWaitFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
